...
console.log(createMenuItem("Ice Cream", 5, "Desert"))
console.log(createMenuItem("Popcorn", 3, "Snack"))
...
function addReviews(array, name, rating, feedback){
  array.push({name, rating, feedback});
  return array;
}
console.log(addReviews(reviews, "Dionne", 1, "bad"))
...
function getLastReview(array) {
  let a = array.length - 1;
    return `${array[a].name} gave the restaurant a ${array[a].rating}, and their feedback was: ${array[a].feedback}`
  }
...
function getReviewByRating(arr, num) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i]["rating"] === num || arr[i]["rating"] > num && arr[i]["rating"] < num + 1) {
      newArr.push(arr[i]);
    }
  }
  return newArr;
